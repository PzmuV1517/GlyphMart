...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-nothing-black flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <p className="mt-2 text-nothing-gray-400">
            Sign in to your GlyphMart account
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <Link
                to="/forgot-password"
                className="text-nothing-red hover:text-red-400 transition-colors duration-200"
              >
